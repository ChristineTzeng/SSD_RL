...
class AC_Network():
    ...
    def __init__(self,scope,trainer):
        ...
        with tf.variable_scope(scope):
            ...
            self.inputs = tf.placeholder(shape=[None,VIEW_WIDTH*VIEW_HEIGHT],dtype=tf.float32)
            self.imageIn = tf.reshape(self.inputs,shape=[-1,VIEW_WIDTH,VIEW_HEIGHT,1])
            ...
            self.policy = slim.fully_connected(rnn_out,NUM_ACTION,
